    ...
    <body style="font-family: 'CenturyGothic'; color: white;">
        <%
            ...
            String actualizacion = "UPDATE anime SET "
                    + "nomAnime=' " + request.getParameter("nombre")
                    + " ', sagaAnime='" + request.getParameter("saga")
                    + " ', genreAnime='" + request.getParameter("genero")
                    + " ', numAnime=" + Integer.valueOf(request.getParameter("numero"))
                    + " WHERE animeID=" + Integer.valueOf(request.getParameter("animeID"));
